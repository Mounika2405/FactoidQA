...
class MagnitudeVectors():
    ...
    def __init__(self, emdim):
        ...
        #fname = os.path.join(base_dir, 'magnitude/conceptnet.magnitude')
        #conceptnet = Magnitude(fname)
        #self.vectors = Magnitude(glove, fasttext, conceptnet)
        #print("ConceptNet:", conceptnet)
